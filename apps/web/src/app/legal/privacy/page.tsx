      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mt-10">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-500">
            ...
            conforme al Reglamento General de Protección de Datos (RGPD), la Ley
            Orgánica 3/2018 (LOPDGDD) y la normativa europea aplicable.
          </p>
        ...
        <div className="mt-16 space-y-14 text-[17px] leading-9 text-slate-700">
          ...
          <section>
            ...
            <p className="mt-5">
              ...
              servicios ofrecidos por LookUp, mejorar la experiencia del
              usuario, garantizar la seguridad de la plataforma y cumplir con
          ...
          <section>
            ...
            <p className="mt-5">
              ...
              necesario para prestar el servicio o mientras exista una
              obligación legal que así lo requiera.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-5">
              ...
              proteger la información frente a accesos no autorizados, pérdidas,
          ...
          <section>
            ...
            <p className="mt-5">
              ...
              cambios legales o a nuevas funcionalidades. Cuando los cambios
              sean relevantes se informará a los usuarios antes de su entrada en
              vigor.
            </p>
          </section>
          ...
          <section>
            ...
            <p className="mt-5">
              ...
              equipo de LookUp a través de los canales oficiales de soporte de
              la aplicación.
            </p>
          </section>
        </div>
