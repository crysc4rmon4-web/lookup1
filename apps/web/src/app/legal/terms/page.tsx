      ...
      <section className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mt-10">
          ...
          <p className="mt-5 max-w-2xl text-lg leading-8 text-slate-500">
            Estos términos regulan el acceso y uso de la plataforma LookUp. Al
            crear una cuenta aceptas las condiciones descritas en este documento
        ...
        <div className="mt-16 space-y-14 text-[17px] leading-9 text-slate-700">
          <section>
            ...
            <p className="mt-5">
              Al crear una cuenta en LookUp confirmas que has leído, comprendido
              y aceptado íntegramente estos Términos y Condiciones. Si no estás
              de acuerdo con cualquiera de ellos, no deberás utilizar la
              plataforma.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="mt-5 list-disc space-y-3 pl-7">
              <li>
                Tener al menos 18 años cuando la legislación aplicable así lo
                exija.
              </li>
          ...
          <section>
            ...
            <p className="mt-5">
              Cada usuario conserva la propiedad del contenido que publica, pero
              concede a LookUp una licencia limitada para almacenarlo,
