    ...
    return (<section className="flex min-h-[560px] flex-col">
        ...
        <div className="mt-10 rounded-[28px] border border-[#E7E7EF] bg-white p-6">
            ...
            <ul className="mt-5 space-y-3 text-sm leading-7 text-slate-600">
                ...
                <li>• Tu ubicación solo se utilizará para el funcionamiento del radar.</li>

                <li>• Tú decides qué información compartir con otros usuarios.</li>

                <li>• Puedes modificar o eliminar tu cuenta cuando quieras.</li>

                <li>• No está permitido publicar contenido ilegal o suplantar identidades.</li>

                <li>• Algunas funciones están destinadas únicamente a mayores de edad.</li>
