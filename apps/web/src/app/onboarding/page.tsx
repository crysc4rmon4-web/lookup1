...
export default function OnboardingPage() {
  ...
  async function handleNext() {
    ...
    if (!user?.email) {
      setError("No se pudo recuperar el email de tu cuenta.");
      return;
    }
    ...
    try {
      ...
      console.error("❌ Error finalizando onboarding Persona:", error);
  ...
  if (accountType !== "person" || isProfileComplete) {
    return null;
  }
